...
landList = ['Ísland', 'Rússland', 'Bretland', 'Kanada', 'Bandaríkin',
            'Danmörk', 'Þýskaland', 'Póland', 'Finland', 'Svíðjóð']
...
print('Þú mun fara til', landList[randNum01],
      'og vera þar í', randNum02, 'vikur')
